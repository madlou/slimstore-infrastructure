...
then
    ...
    COMPOSE_PROJECT_NAME=slimstore-$1 docker compose -f $1/docker-compose.yaml build $2 $3 $4 $5 $6
    COMPOSE_PROJECT_NAME=slimstore-$1 docker compose -f $1/docker-compose.yaml down $2 $3 $4 $5 $6
    COMPOSE_PROJECT_NAME=slimstore-$1 docker compose -f $1/docker-compose.yaml up -d --no-build $2 $3 $4 $5 $6
fi
if [ $1 = "dev" ]
then
    cd ..
